...
% --------------------------------------------------------------------------
% Majority of the LaTeX boilerplate and stuff is credited to the following people:
...
\makeatletter  % DO NOT REMOVE THIS (Actually, try removing it, compile, and enjoy the stream of errors :) )
...
\cmone{Committee Member 1, Ph.D.}
\cmtwo{Committee Member 2, Ph.D.}
\deptadmin{Department Chair, Ph.D.}  % Department administrator or chair
\graddate{Month, Year}  % e.g May 2017
% --------------------------------------------------------------------------


% Line spacing. The University of Idaho requires thesis formatting to be 1.5-2.0. For LaTeX 1.3=1.5, 1.6=2.0.
\linespread{1.6}
...
%   Your dedication. This section is optional, per handbook.
% \end{center}
% \vspace{\fill}
% \newpage
...
% Appendices are done as chapters
